 ...
 */
final class Version20231102143823 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE publication (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, book_id INT NOT NULL, book_state VARCHAR(255) NOT NULL, price INT DEFAULT NULL, comment LONGTEXT DEFAULT NULL, INDEX IDX_AF3C6779A76ED395 (user_id), INDEX IDX_AF3C677916A2B381 (book_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
